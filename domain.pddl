(define (domain robots2)
    ...
    (:durative-action stack
        ...
        :condition (and
            ...
            (at start (box-at ?b1 ?pos)) (at start (box-free ?b1)) (at start (box-on-table ?b1 ?r))
            ;la caja 2 tiene que estar en la posicion de la grua, en la pila y libre
            (at start (box-at ?b2 ?pos)) (at start (box-free ?b2)) (at start (box-on-pile ?b2 ?r))
        ...
        :effect (and
            ...
            (at start (not (box-on-table ?b1 ?r))) (at end (on ?b1 ?b2)) (at end (box-on-pile ?b1 ?r))
    ...
    (:durative-action first-stack
        :parameters ( ?r - rg ?b - box ?pos - position)
        :duration (= ?duration 2)
        :condition (and
            ;La caja 1 tiene que estar en la posición de la grua, en la mesa y libre
            (at start (box-at ?b ?pos)) (at start (box-free ?b)) (at start (box-on-table ?b ?r))
            ;la pila debe estar vacía
            (at start (pile-empty ?r))
            ;la grua tiene que estar en la posicion y libre
            (at start (robot-at ?r ?pos)) (at start (robot-free ?r))
        )
        :effect (and
            ...
            (at start (not (box-on-table ?b ?r))) (at end (box-on-pile ?b ?r)) (at end (on ?b ?r))
            ;cuando termina la pila no está vacía
            (at end (not (pile-empty ?r)))
            (at end (increase (time-total) 2))
        )
    )
    ...
    (:durative-action un-stack
        ...
        :condition (and
            ...
            (at start (box-at ?b1 ?pos)) (at start (box-free ?b1)) (at start (on ?b1 ?b2)) (at start(box-on-pile ?b1 ?r))
            ;la caja 2 tiene que estar en la posicion de la grua
            (at start (box-at ?b2 ?pos)) (at start(box-on-pile ?b2 ?r))
            ;la grua tiene que estar en la posicion y libre
            (at start (robot-at ?r ?pos)) (at start (robot-free ?r))
        )
        :effect (and
            ...
            (at start (not (on ?b1 ?b2))) (at start (not (box-on-pile ?b1 ?r))) (at end (box-on-table ?b1 ?r))
    ...
    (:durative-action last-un-stack
        ...
        :condition (and
            ...
            (at start (box-at ?b ?pos)) (at start (box-free ?b)) (at start (on ?b ?r)) (at start(box-on-pile ?b ?r))
            ;la grua tiene que estar en la posicion y libre
            (at start (robot-at ?r ?pos)) (at start (robot-free ?r))
        )
        :effect (and
            ...
            (at start (not (on ?b ?r))) (at end (not (box-on-pile ?b ?r))) (at end (box-on-table ?b ?r))
            ;la pila está libre
            (at end (pile-empty ?r))
        )
    )
    ...
    (:durative-action load
        :parameters ( ?rg - rg ?rm - rm ?b - box ?pos - position)
        :duration (= ?duration 2)
        :condition (and
            ;la grua tiene que estar en la posicion y libre
            ...
            (at start (box-at ?b ?pos)) (at start (box-on-table ?b ?rg)) (at start (box-free ?b))
        )
        :effect (and
            ;cuando empieza el robot grua esta ocupado y cuando termina se libera
            ...
            (at start (not (box-on-table ?b ?rg))) (at end (on ?b ?rm))
            (at end (increase (time-total) 2))
        )
    )
    ...
    (:durative-action un-load
        ...
        :condition (and
            ...
            (at start (box-at ?b ?pos)) (at start (on ?b ?rm))
        )
        :effect (and
            ;cuando empieza el robot grua esta ocupado y cuando termina se libera
            (at start (not (robot-free ?rg))) (at end (robot-free ?rg))
            ...
            (at start (not (on ?b ?rm))) (at end (box-on-table ?b ?rg))
            (at end (increase (time-total) 2))
        )
    )
